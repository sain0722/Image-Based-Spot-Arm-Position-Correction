...
class TargetMetadata:
    ...
    def set_data(self, time, hand_coord, median_diff, surf_pixel, transformation_matrix):
        self.metadata = {
            "time": time,
    ...
    def set_transformation_matrix(self, transformation_matrix):
        self.metadata['transformation_matrix'] = transformation_matrix
...
class TargetImageData:
    ...
    def set_data(self, hand_color, depth_color, hand_color_in_depth_frame, depth_data, pointcloud,
                 surf_source_target, overlapped_source_surf, icp_result_pcd, correspondences):
        self.data = {
            ...
            'surf_source_target': surf_source_target,
            'overlapped_source_surf': overlapped_source_surf,
            # 'icp_result_pcd': icp_result_pcd,
