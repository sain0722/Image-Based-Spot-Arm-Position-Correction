...
from control import graph_nav_util
...
class SpotGraphNavRecoding:
    def __init__(self, clients, client_metadata):
        # Client
        self._recording_client      = clients[0]
        self._graph_nav_client      = clients[1]
        self._map_processing_client = clients[2]
    ...
    def get_recording_status(self, *args):
        ...
        if status.is_recording:
            ...
            message = "The recording service is on."
        else:
            print("The recording service is off.")
            message = "The recording service is off."
        return message
